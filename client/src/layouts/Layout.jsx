    ...
    <>
      <aside className="sidebar">
        ...
        <div className="nav">
          ...
          <Link to="/admin/inventory" className={`nav-item ${isActive('/admin/inventory') ? 'active' : ''}`}>
          ...
          <Link to="/admin/sales" className={`nav-item ${isActive('/admin/sales') ? 'active' : ''}`}>
          ...
          <Link to="/admin/clients" className={`nav-item ${isActive('/admin/clients') ? 'active' : ''}`}>
